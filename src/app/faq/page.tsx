...
export default function FAQPage() {
  ...
  const faqItems: FAQItem[] = isEnglish
    ? [
        ...
        { id: '8', question: 'How are results submitted?', answer: 'Both teams submit the match result. When both confirm the same result, the match is recorded automatically. Photo proof is only required if results disagree or a result is rejected — then an admin reviews the proof.', category: 'tournaments' },
    ...
    : [
        ...
        { id: '8', question: 'Hvordan registreres resultater?', answer: 'Begge lag registrerer kampresultatet. Når begge bekrefter samme resultat, registreres kampen automatisk. Bildebevis kreves kun ved uenighet eller avvisning — da ser admin på beviset.', category: 'tournaments' },
