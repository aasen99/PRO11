...
export default function FAQPage() {
  ...
  const faqItems: FAQItem[] = isEnglish
    ? [
        ...
        { id: '8', question: 'How are results submitted?', answer: 'Both teams submit the match result with photo proof (screenshot). When both confirm the same result, the match is recorded automatically. If there is disagreement, an admin is notified.', category: 'tournaments' },
    ...
    : [
        ...
        { id: '8', question: 'Hvordan registreres resultater?', answer: 'Begge lag registrerer kampresultatet med bildebevis (skjermbilde). Når begge bekrefter samme resultat, registreres kampen automatisk. Ved uenighet varsles admin.', category: 'tournaments' },
